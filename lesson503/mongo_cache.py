...
class MongoCache:
    ...
    def __init__(self, client=None, expires=timedelta(days=30)):
        ...
        self.col.create_index('timestamp', expireAfterSeconds=expires.total_seconds())
    ...
    def __getitem__(self, url):
        ...
        """
        record = self.col.find_one({'url': url})
        if record:
    ...
    def __setitem__(self, url, result):
        ...
        self.col.update_one({'url': url}, {'$set': record}, upsert=True)
